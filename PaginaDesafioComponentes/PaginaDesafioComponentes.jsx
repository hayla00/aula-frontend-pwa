...
const PaginaDesafioComponentes = () => {
  ...
  return (
    ...
    <Principal titulo="Desafio dos Componentes" voltarPara="/">
      ...
      <MostrarSoma numeroUm="10" numeroDois="6" />
      <hr />
      ...
      <MostrarSubtracao numeroUm="20" numeroDois="2" />
     <hr/> 
      ...
      <MostrarDivisao numeroUm="100" numeroDois="10" />
     <hr/> 
      ...
      <MostrarMultiplicacao numeroUm="100" numeroDois="10" />
     <hr/> 
      ...
      <MostrarMeuNomeCompleto nome="Hayla Alzirio" sobrenome="Alves" />
     <hr/> 
